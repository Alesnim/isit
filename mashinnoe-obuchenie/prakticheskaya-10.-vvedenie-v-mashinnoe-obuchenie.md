...
### Задание 1. Оптимизация функций в Scipy

{% hint style="info" %}
Функция `optimize.minimize `ожидает на вход функцию возвращающую `OptimizeResult`
{% endhint %}

1. Прочесть справку про функциям `minimize`
