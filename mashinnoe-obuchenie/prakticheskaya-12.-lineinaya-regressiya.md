...
Теперь воспользуемся функцией `reglin` для восстановления зависимости:

```text
[a,b] = reglin(x,y)
```

После поиска функция возвращает коэфициенты линейной зависимости $$a \cdot x +b $$ . Построим график прямой с найденными коэфициентами:

```text
plot(x, a*x+b, 'g--')
```

Полученный графии изображены на рисунке 1.

![&#x420;&#x438;&#x441;&#x443;&#x43D;&#x43E;&#x43A; 1 - &#x413;&#x440;&#x430;&#x444;&#x438;&#x43A;&#x438; &#x43F;&#x43E;&#x438;&#x441;&#x43A;&#x430; &#x43B;&#x438;&#x43D;&#x435;&#x439;&#x43D;&#x43E;&#x439; &#x437;&#x430;&#x432;&#x438;&#x441;&#x438;&#x43C;&#x43E;&#x441;&#x442;&#x438;](../.gitbook/assets/image%20%2855%29.png)

## Ход работы 

### Задание 1. Линейная регрессия в Scilab
