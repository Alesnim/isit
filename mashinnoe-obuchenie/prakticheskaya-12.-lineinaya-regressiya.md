...
Соответствующий функционал называется средним_ абсолютным отклонением_ (mean absolute error, MAE):
...
![Рисунок 1 - Графики регрессии на выборке](<../.gitbook/assets/image (76).png>)
