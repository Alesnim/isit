...
Гораздо более информативными критериями являются _точность _(precision) и _полнота _(recall):
...
![Рисунок 2,3 ](<../.gitbook/assets/image (56).png>)
...
![Рисунок 3 - Пример ROC-кривой](<../.gitbook/assets/image (57).png>)
...
Данная величина также называется_ отступом_ (margin).
...
| <p>versicolor </p><p></p> | 0.92      | 1.00   | 0.96      | 11       |
...
![График описыющий результат работы машины векторов](<../.gitbook/assets/image (82).png>)

![График описывающий результат работы логистической регрессии](<../.gitbook/assets/image (84).png>)
