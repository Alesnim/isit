...
2. Составить программу управляющую кондиционером. При высокой температуре кондиционер должен включатся и менять фактическую температуру в комнате на более низкую.
