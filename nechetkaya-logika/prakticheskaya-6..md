...
![Рисунок 1 - Архитектура нечеткого контроллера](<../.gitbook/assets/image (44).png>)
...
![Рисунок 2 - Архитектура управления с эталонной моделью](<../.gitbook/assets/image (42).png>)
...
![Рисунок 3 - Архитектура системы управления с коррекцией ](<../.gitbook/assets/image (43).png>)
