...
![Пример определения функций принадлежности для лингвистических термов ](<../.gitbook/assets/image (19).png>)
...
![График принадлежности для переменной "вес"](<../.gitbook/assets/image (17).png>)
...
![График принадлежности для переменной "количество зубчиков"](<../.gitbook/assets/image (18).png>)
